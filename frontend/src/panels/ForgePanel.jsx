      ...
      <div style={{ display:'flex', flexDirection:'column', gap:10, height:'100%' }}>
        ...
        {forgeTxHash && (
          <div style={{
            ...
            padding:'6px 10px',
            fontFamily:"'Courier Prime', monospace", fontSize:11, color:'rgba(255,255,255,0.55)',
          }}>
            <span style={{color:'rgba(255,255,255,0.55)'}}>TX </span>
      ...
      return (
        <div style={{ display:'flex', flexDirection:'column', gap:10, height:'100%', animation:'deliveredPop 0.35s ease-out' }}>
          ...
          <div style={{
            ...
            <div style={{ fontFamily:"'Courier Prime', monospace", fontSize:12, color:'rgba(255,255,255,0.55)' }}>
      ...
      <div style={{ display:'flex', flexDirection:'column', gap:10, height:'100%', animation:'deliveredPop 0.35s ease-out' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontFamily:"'Press Start 2P', monospace", fontSize:8, color:'rgba(255,255,255,0.55)', marginBottom:8 }}>
              YOUR ODDS
            </div>
            <div style={{ fontFamily:"'VT323', monospace", fontSize:36, color:'#ff8888' }}>
              {pct}%
            </div>
            <div style={{ fontFamily:"'Courier Prime', monospace", fontSize:12, color:'rgba(255,255,255,0.55)', marginTop:4 }}>
  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', gap:10, height:'100%' }}>
      ...
      <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between' }}>
        <div style={{ fontFamily:"'Press Start 2P', monospace", fontSize:8, color:'rgba(255,255,255,0.55)', letterSpacing:1 }}>
      ...
      {batchMode && (
        <div style={{ fontFamily:"'Courier Prime', monospace", fontSize:11, color:'rgba(255,255,255,0.55)' }}>
        ...
        {[7,6,5,4,3,2].map(tid => {
          ...
          return (
            <button key={tid} onClick={() => enabled && setSelTier(selected ? null : tid)} style={{
              ...
              <div style={{ fontFamily:"'VT323', monospace", fontSize:20, color: selected ? t.accent : 'rgba(255,255,255,0.55)' }}>×{count}</div>
            </button>
          )
        })}
      </div>
      ...
      {selTier && sel && target ? (
                ...
                <div style={{ flex:'0 0 55%', display:'flex', flexDirection:'column', gap:10 }}>
                  <div style={{ background:'rgba(0,0,0,0.3)', border:'1px solid rgba(255,255,255,0.08)', padding:'10px 12px' }}>
                    <div style={{ display:'flex', justifyContent:'space-between', marginBottom:6 }}>
                      <span style={{ fontFamily:"'Press Start 2P', monospace", fontSize:8, color:'rgba(255,255,255,0.55)' }}>BURN COUNT</span>
                    ...
                    <div style={{ display:'flex', justifyContent:'space-between', marginTop:4 }}>
                      <span style={{ fontFamily:"'Press Start 2P', monospace", fontSize:8, color:'rgba(255,255,255,0.55)' }}>10 = {Math.round((10 / ratio) * 100)}%</span>
                      <span style={{ fontFamily:"'Press Start 2P', monospace", fontSize:8, color:'rgba(255,255,255,0.55)' }}>{maxBurn} = {Math.min(Math.round((maxBurn / ratio) * 100), 100)}%</span>
                    </div>
                  </div>

                  <div style={{ background:'rgba(0,0,0,0.2)', border:'1px solid rgba(255,255,255,0.06)', padding:'8px 12px' }}>
                    <div style={{ fontFamily:"'Press Start 2P', monospace", fontSize:8, color:'rgba(255,255,255,0.55)', marginBottom:4 }}>HOLDINGS IMPACT</div>
                    <div style={{ fontFamily:"'Courier Prime', monospace", fontSize:12, color:'rgba(255,255,255,0.55)', lineHeight:1.6 }}>
                ...
                <div style={{ flex:'0 0 calc(45% - 16px)', display:'flex', flexDirection:'column', alignItems:'center', gap:10 }}>
                  <div style={{ display:'flex', alignItems:'center', gap:10, width:'100%', justifyContent:'center' }}>
                    <div style={{
                      ...
                      <div style={{ fontFamily:"'VT323', monospace", fontSize:20, color:'rgba(255,255,255,0.55)', marginTop:2 }}>×{burnCount}</div>
                    </div>
                    ...
                    <div style={{
                      ...
                      <div style={{ fontFamily:"'VT323', monospace", fontSize:20, color:'rgba(255,255,255,0.55)', marginTop:2 }}>×1</div>
                    </div>
                  </div>
                  ...
                  <div style={{
                    ...
                    <div style={{ fontFamily:"'Press Start 2P', monospace", fontSize:8, color:'rgba(255,255,255,0.55)' }}>
                      CHANCE
                    </div>
                  </div>
                  ...
                  <div style={{ width:'100%', display:'flex', flexDirection:'column', gap:4 }}>
                    <div style={{ background:'rgba(110,255,138,0.06)', border:'1px solid rgba(110,255,138,0.15)', padding:'6px 10px' }}>
                      ...
                      <span style={{ fontFamily:"'Courier Prime', monospace", fontSize:11, color:'rgba(255,255,255,0.55)' }}>+1 {target.name}</span>
                    </div>
                    <div style={{ background:'rgba(255,80,80,0.06)', border:'1px solid rgba(255,80,80,0.15)', padding:'6px 10px' }}>
                      ...
                      <span style={{ fontFamily:"'Courier Prime', monospace", fontSize:11, color:'rgba(255,255,255,0.55)' }}>-{burnCount} {sel.name}</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:10 }}>
            ...
            {[7,6,5,4,3].map(tid => {
              ...
              return (
                <div key={tid} style={{
                  ...
                  <span style={{ fontFamily:"'VT323', monospace", fontSize:20, color:'rgba(255,255,255,0.55)', width:40 }}>×{count}</span>
                  <span style={{ fontFamily:"'Courier Prime', monospace", fontSize:11, color: canForge ? '#6eff8a' : 'rgba(255,255,255,0.55)', flex:1 }}>
          ...
          <div style={{ background:'rgba(0,0,0,0.25)', border:'1px solid rgba(255,255,255,0.06)', padding:'10px 12px' }}>
            <div style={{ fontFamily:"'Press Start 2P', monospace", fontSize:8, color:'rgba(255,255,255,0.55)', letterSpacing:1, marginBottom:6 }}>
              HOW THE FORGE WORKS
            </div>
            <div style={{ display:'flex', flexDirection:'column', gap:2 }}>
              {[
                ...
                <div key={r.from} style={{ display:'flex', alignItems:'center', gap:8, padding:'2px 0' }}>
                  <span style={{ fontFamily:"'Press Start 2P', monospace", fontSize:8, color:'rgba(255,255,255,0.55)', width:52 }}>{r.from}</span>
                  <span style={{ fontFamily:"'Courier Prime', monospace", fontSize:11, color:'rgba(255,255,255,0.55)' }}>
                    Burn 10-{r.ratio} of {r.ratio} = {Math.round(10/r.ratio*100)}%-100% chance
                  </span>
                </div>
              ))}
            </div>
            <div style={{ fontFamily:"'Courier Prime', monospace", fontSize:11, color:'rgba(255,255,255,0.55)', marginTop:6 }}>
          ...
          {batchAttempts.map((a, i) => {
            ...
            return (
              <div key={i} style={{
                ...
                <span style={{ fontFamily:"'Press Start 2P', monospace", fontSize:8, color:'rgba(255,255,255,0.55)', width:16 }}>#{i+1}</span>
                <span style={{ fontFamily:"'Press Start 2P', monospace", fontSize:8, color:t?.accent || '#fff' }}>T{a.tier} → T{a.tier-1}</span>
                <span style={{ fontFamily:"'VT323', monospace", fontSize:20, color:'rgba(255,255,255,0.55)', flex:1 }}>
                  Burn: {a.burnCount}
                </span>
