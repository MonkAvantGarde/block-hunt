import {
  ...
  call_exports,
  mini_exports
} from "./chunk-73JXSKBK.js";
import "./chunk-K6MUIQ2W.js";
...
import {
  withRetry,
  withTimeout
} from "./chunk-5RWBORRY.js";
import "./chunk-RIP4HIVH.js";
...
import {
  ...
  polygonAmoy,
  sepolia
} from "./chunk-2I57BRZQ.js";
import "./chunk-22HAPFGL.js";
import "./chunk-NC2HPMT6.js";
import {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-C7SMJOVY.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-FPIB6CDI.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-URVKA2YO.js");
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./dist-MV4NB5QB.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-URYQCXPM.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-AW3MSTSB.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-5NTAXU5T.js");
